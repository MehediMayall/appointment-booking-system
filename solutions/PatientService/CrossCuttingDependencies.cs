...
public static class CrossCuttingDependencies
{
    ...
    public static IServiceCollection RegisterSwagger(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var xmlFile = $"PatientService.xml";
        ...
        services.AddSwaggerGen(options => {
            ...
            new OpenApiInfo
            {
                Title = "abs Patient Services API",
                Version = "v1",
                Description = "abs Patient Services API",
                ...
                {
                    Name = "MIT License",
                    Url = new Uri("https://github.com/MehediMayall/PatientService/blob/main/LICENSE")
                },
